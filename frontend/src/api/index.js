...
export const toursApi = {
  ...
  saveDaySchedules: (id, days)     => api.post(`/tours/${id}/day-schedules`, days),
  sendTourReminder: (id)           => api.post(`/tours/${id}/send-reminder`),
}
...
export const majalisApi = {
  ...
  create:              (data)      => api.post('/majalis', data),
  update:              (id, data)  => api.put(`/majalis/${id}`, data),
  remove:              (id)        => api.delete(`/majalis/${id}`),
  getProgram:          (id)        => api.get(`/majalis/${id}/program`),
  saveProgram:         (id, items) => api.post(`/majalis/${id}/program`, items),
  getNamazTimings:     (date)      => api.get('/majalis/namaz-timings', { params: { date } }),
  saveNamazTimings:    (data)      => api.post('/majalis/namaz-timings', data),
  getFoodSchedule:     (date)      => api.get('/majalis/food-schedule', { params: { date } }),
  createFoodSchedule:  (data)      => api.post('/majalis/food-schedule', data),
  deleteFoodSchedule:  (id)        => api.delete(`/majalis/food-schedule/${id}`),
}
