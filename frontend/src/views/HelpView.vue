...
<template>
  <div class="max-w-4xl mx-auto space-y-6 pb-16">
    ...
    <div class="rounded-2xl overflow-hidden"
         style="background:linear-gradient(135deg,rgba(16,185,129,0.15),rgba(124,58,237,0.15));border:1px solid rgba(16,185,129,0.25);">
      <div class="px-6 py-8 text-center">
        <div class="text-5xl mb-3">📿</div>
        <h1 class="text-3xl font-bold text-white">Misbah ul Hoda</h1>
        <p class="text-emerald-400 font-semibold mt-1">Arbaeen 2026 — User Guide</p>
        <p class="text-slate-400 text-sm mt-2">Everything you need to know about using this system</p>
      </div>
    </div>
    ...
    <div class="flex gap-2 flex-wrap">
      <button v-for="s in sections" :key="s.id" @click="activeSection = s.id"
        :class="['px-4 py-2 rounded-xl text-sm font-medium transition-all',
          activeSection === s.id
            ? 'text-white shadow-lg' : 'text-slate-400 hover:text-white bg-dark-800']"
        :style="activeSection === s.id ? 'background:linear-gradient(135deg,#065f46,#047857)' : ''">
        {{ s.label }}
      </button>
    </div>
    ...
    <div v-if="activeSection === 'overview'" class="space-y-5">
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">What is Misbah ul Hoda?</h2>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">User Roles</h2>
        <div class="space-y-3">
          <div v-for="r in [
            {role:'Pilgrim',icon:'🕌',color:'text-emerald-400',bg:'rgba(16,185,129,0.1)',border:'rgba(16,185,129,0.25)',desc:'Registers, submits travel details, tracks status, views hotel & room, sees Majalis schedule'},
            ...
            <div>
              ...
              <p class="text-slate-400 text-sm mt-0.5">{{ r.desc }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="activeSection === 'pilgrim'" class="space-y-5">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Step 1 — Register & Log In</h2>
        <ol class="space-y-2 text-slate-300 text-sm list-decimal list-inside leading-relaxed">
          <li>Go to the website and click <strong class="text-white">"Pilgrim Portal"</strong></li>
          <li>Click <strong class="text-white">"Register"</strong> — enter your full name, email, and password</li>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Step 2 — Complete Your Profile</h2>
        <div class="overflow-x-auto">
          <table class="w-full text-sm">
            <thead><tr class="border-b border-dark-700">
              <th class="text-left py-2 text-slate-400 font-medium">Field</th>
              <th class="text-left py-2 text-slate-400 font-medium">What to Enter</th>
            </tr></thead>
            <tbody class="divide-y divide-dark-700">
              <tr v-for="f in [
                ...
                <td class="py-2.5 text-white font-medium pr-4">{{ f[0] }}</td>
                <td class="py-2.5 text-slate-400">{{ f[1] }}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="card border-l-4 border-l-amber-500">
        <h2 class="text-white font-bold text-lg mb-3">Step 3 — Set Your Travel Dates</h2>
        <p class="text-slate-300 text-sm mb-3">Under <strong class="text-white">"Travel Details"</strong> enter your arrival and departure information:</p>
        <ul class="space-y-1 text-slate-300 text-sm list-disc list-inside">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">Step 4 — Track Your Application Status</h2>
        <div class="space-y-3">
          <div v-for="s in [
            ...
            {label:'Approved',color:'bg-emerald-900/40 border-emerald-700 text-emerald-300',desc:'You are confirmed for Arbaeen 2026 — congratulations!'},
        ...
        <div class="mt-4 rounded-xl p-3 text-sm" style="background:rgba(16,185,129,0.08);border:1px solid rgba(16,185,129,0.2);">
          <p class="text-emerald-300 text-sm">✅ You will receive an email and in-app notification whenever your status changes.</p>
        </div>
      </div>

      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">Step 5 — Your Hotel & Room</h2>
        <p class="text-slate-300 text-sm mb-3">Once approved and a room is assigned by admin, your portal shows:</p>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">Majalis & Schedule</h2>
        <div class="space-y-3">
          <div v-for="tab in [
            ...
            <div>
              ...
              <p class="text-slate-400 text-sm mt-0.5">{{ tab.desc }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">Live Karwan Tracking</h2>
    ...
    <div v-if="activeSection === 'volunteer'" class="space-y-5">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Volunteer Dashboard</h2>
        <p class="text-slate-300 text-sm mb-4">Log in via the <strong class="text-white">Volunteer Portal</strong> using credentials provided by your admin.</p>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">Check In / Check Out</h2>
        <ul class="space-y-2 text-slate-300 text-sm">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-3">Tasks</h2>
        <ul class="space-y-2 text-slate-300 text-sm">
    ...
    <div v-if="activeSection === 'admin'" class="space-y-5">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Dashboard Overview</h2>
        <p class="text-slate-300 text-sm mb-3">The admin dashboard gives a real-time snapshot of the entire operation:</p>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Managing Pilgrims</h2>
        <div class="overflow-x-auto">
          <table class="w-full text-sm">
            <thead><tr class="border-b border-dark-700">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Majalis Management</h2>
        <ol class="space-y-3 text-slate-300 text-sm list-decimal list-inside leading-relaxed">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Itinerary & Airport Transfers</h2>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Accommodation</h2>
        <ol class="space-y-2 text-slate-300 text-sm list-decimal list-inside">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Other Admin Features</h2>
        <div class="space-y-3">
          <div v-for="f in [
            ...
            <div>
              ...
              <p class="text-slate-400 text-sm mt-0.5">{{ f.desc }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="activeSection === 'notifications'" class="space-y-5">
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">Automatic Notifications</h2>
        <p class="text-slate-400 text-sm mb-4">The system sends these automatically — no manual work needed from admin or pilgrim:</p>
        <div class="space-y-3">
          <div v-for="n in [
            {icon:'✅',color:'text-emerald-400 bg-emerald-900/30 border-emerald-800',title:'Application Approved',who:'Pilgrim',desc:'Email + in-app notification sent instantly when admin approves your application'},
            ...
            {icon:'🚗',color:'text-emerald-400 bg-emerald-900/30 border-emerald-800',title:'Driver Details',who:'Pilgrim',desc:'Driver name, phone, vehicle, and meeting point sent automatically when admin assigns your pickup'},
    ...
    <div v-if="activeSection === 'benefits'" class="space-y-5">
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">🕌 For Pilgrims</h2>
        <div class="space-y-3">
          <div v-for="b in [
            ...
            <div>
              <p class="text-emerald-300 font-semibold text-sm">{{ b.title }}</p>
              <p class="text-slate-400 text-sm">{{ b.desc }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card">
        <h2 class="text-white font-bold text-lg mb-4">⚙️ For Admin</h2>
        <div class="space-y-3">
          <div v-for="b in [
      ...
      <div class="rounded-2xl text-center py-8 px-6"
           style="background:linear-gradient(135deg,rgba(16,185,129,0.12),rgba(124,58,237,0.12));border:1px solid rgba(16,185,129,0.2);">
        <p class="text-2xl mb-3">🌿</p>
        <p class="text-white font-bold text-lg">May Allah (SWT) accept the ziyarat of all pilgrims</p>
        <p class="text-slate-400 text-sm mt-2">Misbah ul Hoda — Arbaeen 2026</p>
      </div>
