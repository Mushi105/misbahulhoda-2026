...
<template>
  <div class="flex flex-col overflow-hidden"
    ...
    <main class="flex-1 overflow-y-auto"
          style="-webkit-overflow-scrolling:touch; overscroll-behavior-y:contain; background:linear-gradient(160deg,#010f05 0%,#021208 40%,#020617 100%); padding-bottom:calc(64px + env(safe-area-inset-bottom));">
      <div class="p-4">
        <router-view />
      </div>
    </main>
